...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 电影资讯名称
     */
    @ColumnInfo(comment="电影资讯名称",type="varchar(200)")
     ...
     * 电影资讯图片
     */
    @ColumnInfo(comment="电影资讯图片",type="varchar(200)")
     ...
     * 电影资讯类型
     */
    @ColumnInfo(comment="电影资讯类型",type="int(11)")
     ...
     * 电影资讯详情
     */
    @ColumnInfo(comment="电影资讯详情",type="longtext")
