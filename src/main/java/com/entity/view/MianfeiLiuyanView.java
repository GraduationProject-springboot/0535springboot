...
public class MianfeiLiuyanView extends MianfeiLiuyanEntity implements Serializable {
	...
	public MianfeiLiuyanView() {

	}

	public MianfeiLiuyanView(MianfeiLiuyanEntity mianfeiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, mianfeiLiuyanEntity);
